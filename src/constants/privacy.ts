...
Route-in이 이용자로부터 수집하는 개인정보는 아래와 같습니다.

회원 가입 시 필수항목으로 계정이름, 이메일, 이름, 나이, 성별, 프로필 사진을 필수항목으로 수집합니다. 

서비스 이용 과정에서 이용자로부터 수집하는 개인정보는 아래와 같습니다.

회원정보 또는 개별 서비스에서 프로필 정보(닉네임, 프로필 사진)를 변경할 수 있습니다. 
프로필 사진은 기본적으로 소셜에서 제공하는 프로필 사진이며, 변경 시 사용자가 프로필 사진을 변경할 수 있습니다.
...
서비스 개발·제공 및 향상, 안전한 인터넷 이용환경 구축 등 아래의 목적으로만 개인정보를 이용합니다.
...
Route-In은 원칙적으로 이용자의 개인정보를 회원 탈퇴 또는 이용목적 달성 시 지체없이 파기하고 있습니다.
